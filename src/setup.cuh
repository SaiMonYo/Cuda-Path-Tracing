...
__global__ void create_cornell(hitable **d_list, hitable **d_world, camera **d_camera, int nx, int ny, curandState *rand_state) {
    if (threadIdx.x == 0 && blockIdx.x == 0) {
        ...
        d_list[i++] = new quad(vec3(343.0f, 548.8f, 227.0f), vec3(343.0f, 548.8f, 332.0f), vec3(213.0f, 548.8f, 332.0f), vec3(213.0f, 548.8f, 227.0f), new lambertian(vec3(1.0f), 15.0f, vec3(1.0f)));
